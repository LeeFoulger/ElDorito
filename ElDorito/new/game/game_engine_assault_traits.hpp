...
namespace blam
{
	enum e_assault_variant_flags : word_flags
	{
		_assault_variant_flags_reset_bomb_on_disarm = 1 << 0,

		k_assault_variant_flags
	};

	enum e_assault_respawn_settings : short
	{
	...
	enum e_assault_game_type_settings : short
	{
	...
	enum e_assault_enemy_bomb_waypoint_settings : short
	{
	...
	enum e_assault_variant_sudden_death_time : short
	{
