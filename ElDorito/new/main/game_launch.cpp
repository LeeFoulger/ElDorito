...
namespace blam
{
    ...
    void main_game_launch(const char* map_name)
    {
        ...
        assert_game_options_verify(&g_launch_globals.options);
        memcpy(&main_game_globals.game_loaded_options, &g_launch_globals.options, sizeof(game_options));
    ...
    // void main_game_launch_default_editor(void);
    // void main_game_launch_legacy(char const*);
    // void main_game_launch_set_active_primary_skulls(long);
    // void main_game_launch_set_active_secondary_skulls(long);
    ...
    // void main_game_launch_set_initial_zone_set_index(long zone_set_index)
    ...
    {
        s_main_game_globals& main_game_globals = main_game_globals_get();
        memcpy(&g_launch_globals.options.game_variant, &main_game_globals.game_loaded_options.game_variant, sizeof(c_game_variant));

        //c_game_variant game_variant();
        //if (game_engine_get_built_in_variant(variant_name, &game_variant))
        //{
        //    g_launch_globals.options.game_mode = _game_mode_multiplayer;
        //    memcpy(&g_launch_globals.options.game_variant, game_variant, sizeof(c_game_variant));
        //}
        //else
        //{
        //    printf("launch: failed to find multiplayer variant '%s'", variant_name);
        //}
    }
